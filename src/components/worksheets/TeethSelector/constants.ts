...
/**
 * VITA Classical shade guide codes (most common in dental labs)
 */
export const VITA_CLASSICAL_SHADES: string[] = [
  'A1', 'A2', 'A3', 'A3.5', 'A4',
  'B1', 'B2', 'B3', 'B4',
  'C1', 'C2', 'C3', 'C4',
  'D2', 'D3', 'D4',
...
/**
 * VITA 3D-Master shade codes
 */
export const VITA_3D_MASTER_SHADES: string[] = [
  '0M1', '0M2', '0M3',
  '1M1', '1M2',
