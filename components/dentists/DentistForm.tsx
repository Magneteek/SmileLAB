...
const createDentistFormSchema = (t: any) => z.object({
  ...
  email: z.string().email(t('dentist.validationEmailInvalid')),
  phone: z.string().min(1, t('dentist.validationPhoneRequired')).max(50),
  address: z.string().min(1, t('dentist.validationAddressRequired')).max(500),
